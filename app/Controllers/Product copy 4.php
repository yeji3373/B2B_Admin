...
class Product extends BaseController {
  ...
  public function exportData() {
    ...
    $header = [ 'Barcode', 'Product Code', 'Product Thumbnail 파일경로', '브랜드명', 'Product Name (KOR)', 'Product Name (ENG)',
                'Box(묶음) 구성', '박스 내 상품개수', '박스내 구성품 (다른 상품 묶음)', 'Spec', 'Spec2', 'container 1: 용기상품 예)아이패치',
                '상품 스펙 상세(1.5g)', 'Spec Piece(60개)', 'Weight(g)', 'Sample', 'Type', 'Type (ENG)', 'Set', 'Set Detail', 'Renewal',
                '기타', '상품판매여부 1:판매안함', 'Display 1:표시함', '소비자가', '공급가 (수동공급가 ,구분해서 입력)', '공급률 사용여부 1:공급률사용', 
                '공급률', '공급가 수동변경 1:수동변경', '직접입력 값 /로 구분해서 입력', '영세 0:영세&과세 1:영세 2:과세' ];
    ...
    $this->dataFile->exportData($header, $products, $fileName);
  }
